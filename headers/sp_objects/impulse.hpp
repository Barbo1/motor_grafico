...
/* 
  posible to: 
    + IT_FAN, UT_POSITION, FT_LINEAR 
    + IT_FAN, UT_POSITION, FT_QUADRATIC 
    + IT_FAN, UT_POSITION, FT_CUBIC 
    + IT_FAN, UT_POSITION, FT_SINUSOIDAL
    + IT_FAN, UT_POSITION, FT_EXPONENTIAL
*/
template <Function F>
