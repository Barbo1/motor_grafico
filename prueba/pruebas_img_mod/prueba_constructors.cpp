...
int main () {
  ...
  Visualizer<D2FIG> tex_3 = ImageModifier::circle(arena, 10, color2).cast(glb);
  Visualizer<D2FIG> tex_4 = ImageModifier::circle(arena, 7, color2).cast(glb);
  Visualizer<D2FIG> tex_5 = ImageModifier::rounded_square(arena, 100, 150, 13, color1).cast(glb);
